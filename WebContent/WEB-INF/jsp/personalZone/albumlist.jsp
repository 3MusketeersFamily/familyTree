		...
		<div style="background:#fff;border-radius:4px;min-height:480px;">
            <div style="border-bottom:2px solid #CFEBF5;">
                <ul style="overflow:hidden;">
                    ...
                    <li style="float:left;"><a style="display:block;margin:10px 20px;color: #2595B7;font-size:14px;">创建相册</a></li>
                </ul>
            </div>
            <div>
            	<ul style="margin:10px;overflow:hidden;">
					<li style="float:left;height: 180px;width:160px;"> 
                    	<img src="${basePath}images/personalZone/guyuetao.jpeg" style="display:block;width: 140px;height: 150px;padding:5px 10px;">
                        <div style="width:100%;text-align:center;font-size:14px;color:#444;white-space:nowrap;text-overflow:ellipsis;overflow: hidden;">古越古越涛古越涛古越涛古越涛涛</div>
                    </li>
					<li style="float:left;height: 180px;width:160px;"> 
                    	<img src="${basePath}images/personalZone/guyuetao.jpeg" style="display:block;width: 140px;height: 150px;padding:5px 10px;">
                        <div style="text-align:center;font-size:14px;color:#444;">古越涛</div>
                    </li>
					<li style="float:left;height: 180px;width:160px;"> 
                    	<img src="${basePath}images/personalZone/guyuetao.jpeg" style="display:block;width: 140px;height: 150px;padding:5px 10px;">
                        <div style="text-align:center;font-size:14px;color:#444;">古越涛</div>
