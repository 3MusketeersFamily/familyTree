	...
	<div style="float:left;min-height:400px;border-left:solid 1px #eee;">
		<form action="" method="post" class="form form-horizontal" style="width:900px;margin-left:60px;margin-top:50px;">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-5">
					<input type="text" class="input-text" placeholder="出生地" name="email" id="email" datatype="e" nullmsg="请输入邮箱！">
				</div>
				<div class="col-xs-5"> </div>
			</div>
			<div class="row cl">
				...
				<div class="formControls col-xs-5">
					<input type="text" class="input-text" placeholder="15或18位身份证" name="email" id="email" datatype="e" nullmsg="请输入邮箱！">
				</div>
				<div class="col-xs-5"> </div>
			</div>
			<div class="row cl">
